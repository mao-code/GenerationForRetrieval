...
class GFRConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`GFRModel`]. It is used to instantiate a
    GFR model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of the GFR-v0.1 model.

    [Zyphra/GFR-7B-v1](https://huggingface.co/Zyphra/GFR-7B-v1)
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            Vocabulary size of the GFR model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`GFRModel`]
    ...
    def __init__(
        ...
        hidden_size=1024,           # divisible by 16 (attention heads)
